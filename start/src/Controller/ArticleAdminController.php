...
class ArticleAdminController extends AbstractController
{
    ...
    public function new(EntityManagerInterface $manager)
    {
        ...
        $article->setSlug('why-asteroids-taste-like-bacon'.rand (10,99));
...
Spicy **jalapeno** *bacon* ipsum dolor amet veniam shank in dolore. Ham hock nisi landjaeger cow,
    **lorem** proident beef ribs aute enim veniam ut cillum pork chuck picanha. Dolore reprehenderit
    labore minim pork belly spare ribs [cupim](http://google.com) short loin in. Elit exercitation eiusmod dolore cow
...
EOF
        ...
        //$articleRepositroy = new ArticleRepository($article);
        $manager->persist ($article);
        $manager->flush ();
        return new Response(sprintf ('Article id: #%d Article slug: %s',
            $article->getId (),
            $article->getSlug ()
        ));
    }
